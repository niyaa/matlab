...
drho (mapI)=nxI*(rhof (vmapI)-rhofin )/2.0-lmI*(rho(vmapI) -rhoin);  
drhou(mapI)=nxI*(rhouf(vmapI)-rhoufin)/2.0-lmI*(rhou(vmapI)-rhouin);
dEner(mapI)=nxI*(Enerf(vmapI)-Enerfin)/2.0-lmI*(Ener(vmapI)-Enerin);
...
drho (mapO)=nxO*(rhof(vmapO) - rhofout)/2.0-lmO*(rho (vmapO)- rhoout);  
drhou(mapO)=nxO*(rhouf(vmapO)-rhoufout)/2.0-lmO*(rhou(vmapO)-rhouout);
dEner(mapO)=nxO*(Enerf(vmapO)-Enerfout)/2.0-lmO*(Ener(vmapO)-Enerout);
